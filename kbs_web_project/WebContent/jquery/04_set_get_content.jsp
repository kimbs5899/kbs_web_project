	...
	<script>
		$("document").ready(function() {
			...
			$("#set_data").on({
				click : function() {
					// 1. form 태그에 데이터 넣기
					$("#name").val("홍길동"); // value -> val()
					
					// 2. innerHTML -> text()
					$("#addr").text("서울시 강남구");
					
					// 3. innerHTML -> html() html태그를 쓸때
					$("#hobby").html("<li>게임하기</li>");
					
					// 4. append (html태그)
					$("#hobby").append("<li>노래하기</li>").append("<li>등산하기</li>")
					.append("<li>운동하기</li>").append("<li>공부하기</li>");
					
					// a태그 링크 형태로 d1에 추가하기
					$("#d1").html("<a href='http://www.naver.com' target='_blank'>naver</a>");
					$("#d2").html("<img src='../images/muscle_image.png'>");
					$("#d2 > img").css("width", "10%");
